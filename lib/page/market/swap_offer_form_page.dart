...
class SwapOfferFormPage extends StatefulWidget {
  final String postDocument;

  const SwapOfferFormPage({Key key, this.postDocument}) : super(key: key);
  @override
  _SwapOfferFormPageState createState() => new _SwapOfferFormPageState();
}

class _SwapOfferFormPageState extends State<SwapOfferFormPage> {
                                        ...
                                        if (userData.phoneNumber.isNotEmpty) {
                                          if (difference.inDays >
                                            ...
                                            await DatabaseService()
                                                .addSwapOfferItemToFirebase(
                                              userId: user.uid,
                                              username: userData.username,
                                              urlProfile: userData.urlProfile,
                                              tadeSwapId: widget.postDocument,
                                              itemImages: urlLinks,
                                              itemName: _itemName,
